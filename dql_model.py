...
pretrain_length = batch_size    # The number of experience tuples stored in memory when initializing it
...
class DQNetwork():
    def __init__(self, state_size, action_size, actions, save_path, learning_rate=0.0002, gamma=0.95, name='DQNetwork'):
