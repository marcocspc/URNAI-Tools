...
def main(unused_argv):
    ...
    try:
        ...
        env = SC2Env(map_name="Simple64", players=players, render=False, step_mul=22)
        ...
        test_params = TestParams(num_matches=1, steps_per_test=5, max_steps=5000, reward_threshold=100000)
