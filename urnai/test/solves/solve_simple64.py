...
def main(unused_argv):
    try:
        ...
        env = SC2Env(map_name="Simple64", render=False, step_mul=200, player_race="terran", enemy_race="random", difficulty="very_easy")
        ...
        trainer = Trainer(env, agent, save_path='urnai/models/saved', file_name="terran_ddqn_test_realtime4", 
